...
class TransformerConfig(ModelParallelConfig):
    ...
    Args:
        ...
        use_parallel_residual (bool): If true, use parallel residual connection like in PaLM. Defaults to False.
    ...
    def __post_init__(self):
        ...
        if self.dsparse_factor is not None:
            ...
            print(
                "Got dsparse config with factor: ",
                self.dsparse_factor,
                " and nblocks: ",
                self.dsparse_nblocks,
            )
        ...
        if self.num_moe_experts is not None and self.use_parallel_residual:
            raise ValueError(f'Parallel residual is not supported with MoE.')
